...
$pageKeywords = '10 percent off, 10% discount, deals 10 off, 10 percent discount';
$discountLabel = '10% OFF';
$minDiscount = 10;
$maxDiscount = 19;
$discountColor = '#9e9e9e';
$discountIcon = '🎫';
$discountMessage = 'Small savings add up! Get 10% off on quality products.';
