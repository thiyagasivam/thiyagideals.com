...
$canonicalUrl = SITE_URL . '/eco-friendly';
...
$pageTitle = "Eco-Friendly Products 2025";
$metaDescription = "Environment-friendly products and deals - Find Eco-Friendly Products with massive discounts and offers.";
$pageDescription = $metaDescription;
$pageKeywords = "Eco-Friendly Products, deals, offers, discounts, online shopping";
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Environment-friendly products and deals</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Eco-Friendly Products</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    <h2>Eco-Friendly Products - Best Offers 2025</h2>
                    <p>Environment-friendly products and deals</p>
                    
                    <h3>Why Shop Eco-Friendly Products?</h3>
                    <ul>
                    ...
                    <p>Browse through our curated collection of Eco-Friendly Products. 
