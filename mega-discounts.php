...
$canonicalUrl = SITE_URL . '/mega-discounts';
...
$pageTitle = "Mega Discounts - 60% OFF or More 2025";
$metaDescription = "Massive discounts of 60% and above - Find Mega Discounts - 60% OFF or More with massive discounts and offers.";
$pageDescription = $metaDescription;
$pageKeywords = "Mega Discounts - 60% OFF or More, deals, offers, discounts, online shopping";
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Massive discounts of 60% and above</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Mega Discounts - 60% OFF or More</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    <h2>Mega Discounts - 60% OFF or More - Best Offers 2025</h2>
                    <p>Massive discounts of 60% and above</p>
                    
                    <h3>Why Shop Mega Discounts - 60% OFF or More?</h3>
                    <ul>
                    ...
                    <p>Browse through our curated collection of Mega Discounts - 60% OFF or More. 
