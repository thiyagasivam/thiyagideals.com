<?php
/**
 * App Exclusive Deals - Mobile App Only Offers
...
$canonicalUrl = SITE_URL . '/app-exclusive-deals';

$pageTitle = 'App Exclusive Deals - Mobile App Only Offers';
$pageDescription = 'App exclusive deals! Mobile app only offers with extra discounts. Download app for special deals.';
$pageKeywords = 'app exclusive, mobile app deals, app only offers, application discounts';
...
if ($allDeals && is_array($allDeals)) {
    ...
    $brandKeywords = ['app', 'mobile', 'application'];
