...
$canonicalUrl = SITE_URL . '/oneplus-deals';

$pageTitle = 'OnePlus Deals & Offers';
$pageDescription = 'Latest OnePlus smartphone deals. Get best prices on OnePlus mobile phones, TVs, and accessories with amazing discounts.';
$pageKeywords = 'oneplus deals, oneplus mobile offers, oneplus discount, oneplus phone deals';
$brandName = 'OnePlus';
$brandKeywords = ['oneplus', 'one plus'];
$brandColor = '#eb0028';
$brandIcon = '📱';
