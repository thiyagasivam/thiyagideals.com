...
$canonicalUrl = SITE_URL . '/last-chance';
...
$pageTitle = "Last Chance - Ending Soon 2026";
$metaDescription = "Deals ending soon - grab before expiry - Find Last Chance - Ending Soon with massive discounts and offers.";
$pageDescription = $metaDescription;
$pageKeywords = "Last Chance - Ending Soon, deals, offers, discounts, online shopping";
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Deals ending soon - grab before expiry</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Last Chance - Ending Soon</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    <h2>Last Chance - Ending Soon - Best Offers 2026</h2>
                    <p>Deals ending soon - grab before expiry</p>
                    
                    <h3>Why Shop Last Chance - Ending Soon?</h3>
                    <ul>
                    ...
                    <p>Browse through our curated collection of Last Chance - Ending Soon. 
