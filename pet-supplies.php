...
$canonicalUrl = SITE_URL . '/pet-supplies';
...
$filteredDeals = array_filter($allDeals, function($deal) {
    ...
    return matchesKeywords($deal['product_name'], ['pet', 'dog', 'cat', 'animal', 'bird']);
});
...
$pageTitle = "Pet Supplies & Accessories 2026";
$metaDescription = "Pet care and supplies at great prices - Find Pet Supplies & Accessories with massive discounts and offers.";
$pageDescription = $metaDescription;
$pageKeywords = "Pet Supplies & Accessories, deals, offers, discounts, online shopping";
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Pet care and supplies at great prices</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Pet Supplies & Accessories</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    <h2>Pet Supplies & Accessories - Best Offers 2026</h2>
                    <p>Pet care and supplies at great prices</p>
                    
                    <h3>Why Shop Pet Supplies & Accessories?</h3>
                    <ul>
                    ...
                    <p>Browse through our curated collection of Pet Supplies & Accessories. 
