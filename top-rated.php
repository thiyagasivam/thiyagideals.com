...
$canonicalUrl = SITE_URL . '/top-rated';
...
$pageTitle = "Top Rated Products 2025";
$metaDescription = "Highest rated products with best reviews - Find Top Rated Products with massive discounts and offers.";
$pageDescription = $metaDescription;
$pageKeywords = "Top Rated Products, deals, offers, discounts, online shopping";
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Highest rated products with best reviews</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Top Rated Products</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    <h2>Top Rated Products - Best Offers 2025</h2>
                    <p>Highest rated products with best reviews</p>
                    
                    <h3>Why Shop Top Rated Products?</h3>
                    <ul>
                    ...
                    <p>Browse through our curated collection of Top Rated Products. 
