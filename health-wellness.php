...
$canonicalUrl = SITE_URL . '/health-wellness';
...
$filteredDeals = array_filter($allDeals, function($deal) {
    ...
    return matchesKeywords($deal['product_name'], ['health', 'wellness', 'vitamin', 'supplement', 'medical']);
});
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Health and wellness products</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Health & Wellness</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    ...
                    <p>Browse through our curated collection of Health & Wellness. 
