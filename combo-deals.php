...
$canonicalUrl = SITE_URL . '/combo-deals';
...
<style>
    .page-header {
        background: linear-gradient(135deg, #fd7e14 0%, <?php echo adjustBrightness('#fd7e14', -30); ?> 100%);
        color: white;
        padding: 60px 0;
        margin-bottom: 40px;
    }
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="lead mb-4">Multi-pack and combo deals</p>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" style="color: rgba(255,255,255,0.8);">Combo & Bundle Offers</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="seo-content" style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
                    ...
                    <p>Browse through our curated collection of Combo & Bundle Offers. 
