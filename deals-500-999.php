...
$pageKeywords = 'deals 500 to 1000, products under 1000, 500-999 deals, budget gadgets';
$priceRange = '₹500 - ₹999';
$minPrice = 500;
$maxPrice = 999;
$rangeColor = '#ffc107';
$rangeIcon = '🎯';
$targetAudience = 'Smart Shoppers';
$popularCategories = 'Wireless Earbuds, Smart Bands, Shoes, Bags, Grooming Kits';
